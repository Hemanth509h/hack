...
export const MATCH_WEIGHTS = {
  skillOverlap: 0.5, // 50% — most important factor for project work
  interestAlignment: 0.25, // 25% — shared interests for cultural fit
  collaborationHistory: 0.15, // 15% — past successful team-ups
  availabilityBonus: 0.1, // 10% — currently open for new projects
};
...
export const computeCollaborationScore = (
  ...
  return Math.min(
    1,
    sharedTeams > 0 ? Math.log(sharedTeams + 1) / Math.log(11) : 0,
  );
};
