    ...
    <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {leadership.map((member) => (
          <div
            key={member._id}
            className="bg-gray-50 dark:bg-gray-800/40 border border-gray-700/50 p-6 rounded-2xl flex items-center gap-4 hover:border-indigo-500/30 transition-all group"
          >
            ...
            <div>
              ...
              <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-indigo-400 transition-colors">
                {member.user.name}
              </h3>
