          ...
          {[1, 2, 3].map((num) => (
            <div
              ...
              className={`relative z-10 w-10 h-10 rounded-2xl flex items-center justify-center font-bold text-sm transition-all duration-300 ${
                step >= num
                  ? "bg-indigo-600 text-gray-900 dark:text-white shadow-[0_0_20px_rgba(79,70,229,0.4)]"
          ...
          <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Every great tribe starts with a clear mission.
                  </p>
                </div>
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    <ImageIcon className="h-5 w-5 text-indigo-400" /> Visuals &
                    Logistics
                  </h2>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Make your club stand out with beautiful imagery.
                  </p>
                </div>
            ...
            {step === 3 && (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Where can members find you online?
                  </p>
                </div>
                ...
                <div className="p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl">
                  <p className="text-indigo-400/80 text-[10px] font-black uppercase tracking-widest leading-relaxed">
                    Protocol: New organizations are initialized instantly and
                    broadcasted to the student pulse.
                  </p>
                </div>
              </motion.div>
            )}
