...
const CAMPUS_RESOURCES = [
  ...
  },
  {
    ...
    name: "Main Canteen",
    category: "Food",
    coords: [-71.105, 42.375],
  },
  {
    id: "din-2",
    type: "dining",
    name: "Starbucks @ Union",
    category: "Coffee",
    coords: [-71.112, 42.372],
  },
  {
    id: "bld-2",
    type: "building",
    name: "Science Center",
    category: "Labs",
    coords: [-71.115, 42.376],
  },
];

export const MapContainer = () => {
  const dispatch = useAppDispatch();
  const { viewport, selectedLocationId, toggles } = useAppSelector(
    (state) => state.map,
  );
      ...
      <div className="w-full h-full bg-white dark:bg-gray-900 flex items-center justify-center p-6 text-center border-l border-black/5 dark:border-white/5">
        <div className="max-w-md">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            ...
            <code className="bg-gray-50 dark:bg-gray-800 px-1 rounded text-red-300">
              VITE_MAPBOX_TOKEN
            </code>{" "}
          ...
          return (
            ...
            >
              <div className="relative flex items-center justify-center">
                ...
                >
                  <MapPin
                    className={`w-4 h-4 ${isSelected ? "text-indigo-400" : "text-indigo-200"}`}
                  />
                </div>
              </div>
            </Marker>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-700 rounded-xl overflow-hidden shadow-2xl p-0 min-w-[240px]">
              ...
              <div className="p-4">
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <button
                    onClick={() => dispatch(setSelectedLocationId(null))}
                    className="text-gray-500 hover:text-gray-900 dark:text-white shrink-0"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-1 text-xs text-gray-600 dark:text-gray-400 mb-3">
                  <span className="flex items-center gap-1.5">
                    ...
                    {selectedEvent.location.name || "Campus Resource"}
                  </span>
                  <span className="flex items-center gap-1.5">
          ...
          >
            <div className="bg-white dark:bg-gray-900 border border-gray-700 rounded-xl overflow-hidden shadow-2xl p-4 min-w-[240px]">
              ...
              <p className="text-xs text-gray-500 mb-4">
                {selectedResource.category} resource available to all students.
              </p>
