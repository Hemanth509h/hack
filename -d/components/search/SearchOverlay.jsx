        ...
        >
          ...
          >
            ...
            <div className="p-10 border-b border-black/5 dark:border-white/5 flex items-center space-x-6 relative overflow-hidden">
              ...
              <button
                onClick={onClose}
                className="p-4 glass bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-2xl text-gray-500 hover:text-gray-900 dark:text-white transition-all"
              >
                <X size={24} />
              </button>
            </div>
            ...
            <div className="overflow-y-auto p-10 custom-scrollbar">
              ...
              {isLoading && (
                <div className="py-20 flex flex-col items-center space-y-6">
                  ...
                  <p className="text-gray-600 font-black uppercase tracking-widest text-[10px]">
                    Scanning Nexus...
                  </p>
                </div>
              )}
              ...
              {!isLoading && query.length >= 2 && (
                <div className="space-y-12">
                  {results.events.length > 0 && (
                    <div>
                      <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mb-6 px-4">
                        Live Events
                      </h3>
                  ...
                  {results.events.length === 0 &&
                    ...
                    results.users.length === 0 && (
                      <div className="py-20 text-center text-gray-600 font-bold">
                        <p className="text-2xl mb-2 tracking-tighter text-gray-900 dark:text-white">
                          No Signal Found
                        </p>
                        <p className="text-xs uppercase tracking-widest">
                          Adjust frequency for "{query}"
                        </p>
                      </div>
                    )}
                </div>
            ...
            <div className="p-8 glass bg-black/5 dark:bg-white/5 flex items-center justify-between">
              <div className="flex items-center space-x-8">
                <span className="flex items-center space-x-3 text-[10px] font-black text-gray-500 uppercase tracking-widest">
                  <kbd className="px-2 py-1 glass bg-black/10 dark:bg-white/10 rounded-lg border border-black/10 dark:border-white/10 text-gray-900 dark:text-white">
                    ENTER
                  </kbd>
                  <span>Select</span>
                </span>
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-6">
        ...
        <div>
          <div className="text-lg font-bold text-gray-900 dark:text-white tracking-tight leading-tight mb-1">
            {title}
          </div>
          {subtitle && (
      ...
      <ArrowRight
        size={20}
        className="text-gray-700 opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all"
      />
    </button>
  );
};
