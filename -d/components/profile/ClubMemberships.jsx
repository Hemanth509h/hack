  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {clubs.map((clubMembership) => (
        <div
          key={clubMembership.club._id}
          className="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl flex items-center hover:border-gray-700 transition-colors shadow-sm group"
        >
          <div className="w-12 h-12 bg-gray-50 dark:bg-gray-800 rounded-lg flex items-center justify-center mr-4 overflow-hidden border border-gray-700 shadow-inner group-hover:border-primary-500/50 transition-colors">
            {clubMembership.club.image ? (
              <img
                src={clubMembership.club.image}
                alt={clubMembership.club.name}
          ...
          <div className="flex-1">
            <h4 className="text-gray-900 dark:text-white font-semibold truncate group-hover:text-primary-400 transition-colors">
          ...
          <Link
            to={`/clubs/${clubMembership.club._id}`}
            className="p-2 text-gray-500 hover:text-gray-900 dark:text-white transition-colors bg-gray-50 dark:bg-gray-800 rounded-lg opacity-0 group-hover:opacity-100 focus:opacity-100"
          >
