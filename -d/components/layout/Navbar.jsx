      ...
      <div className="glass rounded-[1.5rem] h-20 px-8 flex items-center justify-between shadow-2xl border-black/10 dark:border-white/10">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <Search
              size={18}
              className="text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white group-hover:scale-110 transition-all"
            />
            <span className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white transition-colors hidden lg:block font-medium">
              Search...
            </span>
          ...
          >
            {theme === "dark" ? (
              <Sun
                size={18}
                className="text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white group-hover:rotate-90 transition-all"
              />
            ) : (
              <Moon
                size={18}
                className="text-gray-600 group-hover:text-gray-900 group-hover:-rotate-12 transition-all"
              />
            )}
          </button>
          ...
          <div className="relative">
            ...
            >
              <Bell
                size={18}
                className="text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white group-hover:rotate-12 transition-all"
              />
              {unreadCount > 0 && (
  ...
  <Link
    ...
    className={cn(
      ...
      active
        ...
        : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white hover:bg-black/5 dark:hover:bg-white/5",
    )}
  >
    {icon}
