  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 bg-gray-50 dark:bg-[#030303] border-r border-black/5 dark:border-white/5 flex-col z-40 transition-all duration-300">
      <div className="p-10 flex items-center space-x-3">
        ...
        <span className="font-display font-bold text-2xl tracking-tighter text-gray-900 dark:text-white">
          The Quad
        </span>
      </div>
      ...
      <div className="px-6 mb-10">
        ...
        >
          <Search
            size={20}
            className="text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white transition-colors"
          />
          <span className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white transition-colors font-medium">
            Search...
          </span>
        ...
        {navItems.map((item) => (
          <SidebarLink
            ...
            active={
              ...
              (item.to !== "/discover" && location.pathname.startsWith(item.to))
            }
          />
        ))}
      ...
      <div className="p-6 mt-auto flex gap-2">
        ...
        >
          {theme === "dark" ? (
            <Sun size={22} className="group-hover:rotate-90 transition-all" />
          ) : (
            <Moon size={22} className="group-hover:-rotate-12 transition-all" />
          )}
        </button>
        <button
    ...
    <div
      className={cn(
        ...
        active
          ...
          : "text-gray-500 group-hover:text-gray-900 dark:text-white group-hover:scale-110",
      )}
    >
      {icon}
    </div>
