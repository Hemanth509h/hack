        ...
        >
          ...
          <div className="relative p-8 pb-0">
            ...
            <div className="flex items-start gap-5 mb-6">
              <div
                className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${avatarColors[0]} flex items-center justify-center text-gray-900 dark:text-white font-bold text-2xl shrink-0 shadow-xl`}
              >
                {match.user.avatar ? (
                  <img
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  ...
                  {match.user.graduationYear &&
                    ` · Class of ${match.user.graduationYear}`}
                </p>
          ...
          <div className="p-8 pt-4 space-y-6">
            ...
            <div className="bg-white/3 rounded-2xl p-5 border border-black/5 dark:border-white/5">
              ...
              <div className="space-y-3">
                {[
                  {
                    label: "Skill Overlap",
                    value: match.breakdown.skillOverlap,
                    color: "from-indigo-500 to-violet-500",
                  },
                  {
                    label: "Interest Alignment",
                    value: match.breakdown.interestAlignment,
                    color: "from-pink-500 to-rose-500",
                  },
                  {
                    label: "Collaboration History",
                    value: match.breakdown.collaborationHistory,
            ...
            {match.user.skills.length > 0 && (
              <div>
                <h3 className="text-gray-900 dark:text-white font-bold text-sm mb-3 flex items-center gap-2">
                  <Code className="w-4 h-4 text-indigo-400" /> Skills &
                  Expertise
                </h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {match.user.interests.map((interest, i) => (
                    <span
                      key={i}
                      className="text-xs font-semibold text-amber-300 bg-amber-500/10 border border-amber-500/20 px-3 py-1.5 rounded-lg"
                    >
                      {interest}
                    </span>
                  ))}
            ...
            {!sent ? (
              <div className="bg-indigo-500/5 border border-indigo-500/20 rounded-2xl p-5">
                <h3 className="text-gray-900 dark:text-white font-bold text-sm mb-4 flex items-center gap-2">
                  <Send className="w-4 h-4 text-indigo-400" /> Invite to Your
                  Project
                </h3>
                <select
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                  Your team invite has been delivered to {match.user.name}.
                </p>
              </motion.div>
            )}
