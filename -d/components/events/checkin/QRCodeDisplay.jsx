          ...
          >
            ...
            >
              ...
              <div className="bg-gray-50 p-4 border-t border-gray-100 mt-2 flex justify-between items-center text-sm">
                ...
                <button
                  onClick={() => refetch()}
                  className="text-blue-600 font-bold hover:text-blue-700 flex flex-center gap-1.5 px-3 py-1.5 rounded hover:bg-blue-50 transition"
                >
