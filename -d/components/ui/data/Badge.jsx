...
export const Badge = ({
  ...
  const variants = {
    default:
      "bg-black/10 dark:bg-white/10 text-gray-700 dark:text-gray-300 border border-black/5 dark:border-white/5",
    ...
    outline:
      "bg-transparent text-gray-600 dark:text-gray-400 border border-border",
  };
