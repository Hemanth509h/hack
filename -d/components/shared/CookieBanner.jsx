  ...
  return (
    ...
    >
      <div style={{ color: "#e2e8f0", fontSize: "14px", lineHeight: "1.5" }}>
        ...
        <br />
        The Quad uses analytical cookies to understand how students navigate the
        platform, helping us improve AI-matching algorithms and server response
        times.
        <a href="/privacy" style={{ color: "#818cf8", marginLeft: "5px" }}>
          Read More
        </a>
        .
      </div>
