    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-8">
        <div>
          <Link
            to="/profile"
            className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white flex items-center gap-2 mb-2 text-sm transition-colors cursor-pointer"
          >
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Design your public portfolio landing page dynamically.
          </p>
        </div>
      ...
      <div className="space-y-4">
        {sections.map((sec, idx) => (
          <div
            key={sec.id}
            className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 flex gap-4 pr-12 relative group hover:border-gray-700 transition-colors shadow-sm"
          >
