...
const ProfilePage = () => {
  ...
  const isOwner =
    currentUser?.id === profile._id || currentUser?.id === profile.id;
              ...
              <div className="mt-6 flex flex-col gap-3">
                ...
                {profile.portfolioLinks.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center text-sm text-gray-600 dark:text-gray-400 hover:text-[#0a66c2] transition-colors"
                  >
                ...
                {profile.portfolioLinks.website && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center text-sm text-gray-600 dark:text-gray-400 hover:text-primary-400 transition-colors"
                  >
            ...
            {profile.interests && profile.interests.length > 0 ? (
              <div className="flex flex-wrap gap-2">
                {profile.interests.map((interest, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 bg-gray-50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 border border-gray-700/50 rounded-full text-xs"
                  >
                    {interest}
                  </span>
                ))}
