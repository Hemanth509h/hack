...
export default function BroadcastPage() {
  ...
  const handleBroadcast = async (e) => {
    ...
    setTimeout(() => {
      setIsSending(false);
      setSentStatus(
        "Signal broadcasted successfully to all active frequencies.",
      );
      setTitle("");
      setMessage("");
    }, 1500);
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-gray-500 font-medium text-lg">
            Dispatch priority signals to every student in the ecosystem.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8">
          <form
            ...
            className="glass rounded-[3rem] p-10 shadow-2xl border-black/5 dark:border-white/5 space-y-8 relative overflow-hidden"
          >
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="glass rounded-[2.5rem] p-8 border-black/5 dark:border-white/5">
            ...
            <p className="text-gray-500 text-sm leading-relaxed font-medium">
              Global broadcasts are irreversible and trigger instant
              notifications across all active student devices. Use with extreme
              discretion.
            </p>
          </div>
          ...
          <div className="glass rounded-[2.5rem] p-8 border-black/5 dark:border-white/5">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-black/5 dark:bg-white/5 rounded-xl border border-black/5 dark:border-white/5">
                <div className="text-[10px] text-gray-600 font-black uppercase mb-1">
                  2 Hours Ago
                </div>
              ...
              <div className="p-4 bg-black/5 dark:bg-white/5 rounded-xl border border-black/5 dark:border-white/5 opacity-50">
                ...
                <div className="text-gray-900 dark:text-white text-xs font-bold">
                  Welcome to the new Quad Portal!
                </div>
              </div>
            </div>
          </div>
