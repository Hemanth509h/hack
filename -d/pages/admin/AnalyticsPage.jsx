      ...
      <div className="flex flex-col md:flex-row justify-between md:items-end gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Deep dive into platform engagement and demographics.
          </p>
        </div>
        <div className="flex gap-3 flex-wrap">
          <div className="flex bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden p-1">
            <button className="px-3 py-1.5 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg text-sm font-medium">
              Overview
            </button>
            <button className="px-3 py-1.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white rounded-lg text-sm font-medium transition">
              Demographics
            </button>
          </div>
