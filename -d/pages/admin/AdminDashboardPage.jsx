...
const StatCard = ({
  ...
  >
    ...
    <div className="flex justify-between items-start relative z-10">
      <div>
        <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em] mb-3">
          {title}
        </p>
        <h3 className="text-4xl font-display font-black text-gray-900 dark:text-white tracking-tighter leading-tight">
          {value}
        </h3>
      </div>
      <div
        className={cn(
          ...
          alert
            ? "premium-gradient text-gray-900 dark:text-white"
            : "glass bg-black/5 dark:bg-white/5 text-indigo-400 border-black/10 dark:border-white/10",
        )}
      >
        <Icon size={24} />
      </div>
    ...
    <div className="space-y-12 py-6">
      <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-8 px-4">
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-500 font-medium text-xl max-w-xl leading-relaxed">
            System-wide overview of engagement, health, and operational metrics.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <StatCard
          ...
          subValue={
            stats?.newClubRequests?.hasHighPriority
              ? "Urgent Attention"
              : "Standard Review"
          }
          icon={ShieldCheck}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 glass rounded-[3rem] p-10 shadow-[0_30px_60px_rgba(0,0,0,0.4)] relative overflow-hidden border-black/5 dark:border-white/5">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-6">
            <div>
              <h3 className="text-3xl font-display font-black text-gray-900 dark:text-white tracking-tighter">
                Engagement Velocity
              </h3>
              <p className="text-gray-500 font-medium mt-1">
                Real-time RSVP volume across {dateRange.toLowerCase()}ly
                periods.
              </p>
            </div>
            <div className="glass bg-black/5 dark:bg-white/5 p-1 rounded-2xl border-black/10 dark:border-white/10">
              ...
              >
                <option value="Week" className="bg-gray-50 dark:bg-[#030303]">
                  Weekly Period
                </option>
                <option value="Month" className="bg-gray-50 dark:bg-[#030303]">
                  Monthly Period
                </option>
              </select>
            </div>
        ...
        <div className="flex flex-col gap-10">
          <div className="glass rounded-[3rem] p-10 shadow-2xl border-black/5 dark:border-white/5 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-black text-gray-900 dark:text-white mb-8 tracking-tighter">
              Strategic Actions
            </h3>
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="bg-indigo-600 text-gray-900 dark:text-white text-[10px] font-black px-3 py-1 rounded-full shadow-[0_0_15px_rgba(99,102,241,0.4)]">
                    {stats?.newClubRequests?.total || 0}
                  </span>
                </div>
              </button>
              <button
          ...
          <div className="premium-gradient rounded-[3rem] p-10 shadow-[0_30px_60px_rgba(99,102,241,0.3)] relative overflow-hidden flex flex-col items-center text-center">
            ...
            />
            <h3 className="text-2xl font-display font-black text-gray-900 dark:text-white mb-4 tracking-tighter">
              Admin Codex
            </h3>
            <p className="text-indigo-100 text-base mb-10 font-medium leading-relaxed">
              Consult the core protocols for system governance and conflict
              resolution.
            </p>
