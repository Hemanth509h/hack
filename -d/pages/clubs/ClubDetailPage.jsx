...
export const ClubDetailPage = () => {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          The club you are looking for might have been moved or deleted.
        </p>
        <Link
          to="/clubs"
  ...
  const isMember =
    membersData?.members.some(
      (m) => m.user._id === user?.id && m.status === "approved",
    ) || false;
  const isPresident = leadership.some(
    (m) => m.user._id === user?.id && m.role === "president",
  );
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-16 mt-16">
              ...
              {club.tags && club.tags.length > 0 && (
                <div className="flex flex-wrap gap-3 mt-12 relative z-10">
                  {club.tags.map((tag) => (
                    <span
                      key={tag}
                      className="glass bg-black/5 dark:bg-white/5 text-gray-500 px-5 py-2 rounded-xl text-xs font-black uppercase tracking-widest border-black/5 dark:border-white/5 hover:text-indigo-400 transition-colors"
                    >
                      #{tag}
                    </span>
                  ))}
        ...
        <div className="lg:col-span-4 space-y-10">
          ...
          >
            ...
            <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-10">
              Logistics Protocols
            </h3>
            <div className="space-y-10 relative z-10">
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <div className="text-gray-900 dark:text-white text-lg font-bold tracking-tight">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-indigo-100/70 text-base mb-10 leading-relaxed font-medium">
                Our board is seeking visionaries to scale our impact. Inquire
                about vacant leadership protocols.
              </p>
