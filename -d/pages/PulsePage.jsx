  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-6 relative z-10">
        ...
        <div>
          <h4 className="text-gray-900 dark:text-white font-black tracking-tight">
            {post.author.name}
          </h4>
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">
            {post.author.major || "Global Citizen"}
          </p>
        </div>
      ...
      <div className="flex items-center gap-8 pt-6 border-t border-black/5 dark:border-white/5 relative z-10">
        ...
        >
          <div className="p-3 rounded-xl glass bg-black/5 dark:bg-white/5 group-hover/btn:bg-pink-500/20 transition-all">
            <Heart
              className={`w-5 h-5 ${post.likes.length > 0 ? "fill-pink-500 text-pink-500" : "text-gray-500 group-hover/btn:text-pink-400"}`}
            />
          </div>
          <span className="text-xs font-black text-gray-500 group-hover/btn:text-pink-400">
            {post.likes.length}
          </span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-black text-gray-500 group-hover/btn:text-indigo-400">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 gap-8 px-4">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 font-medium text-xl max-w-xl leading-relaxed">
              Broadcast your experience. Connect with the campus heartbeat.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="glass bg-black/5 dark:bg-white/5 px-8 py-4 rounded-[2rem] border-black/5 dark:border-white/5 flex items-center gap-4">
              ...
              <span className="text-gray-900 dark:text-white font-black text-xs uppercase tracking-widest">
                Trending Now
              </span>
            </div>
          </div>
