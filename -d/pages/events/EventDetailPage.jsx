      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-40 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
                ...
                <div className="flex flex-wrap items-center gap-6 text-gray-600 dark:text-gray-400 mb-12 pb-12 border-b border-black/5 dark:border-white/5">
                  <div className="flex items-center glass bg-black/5 dark:bg-white/5 px-6 py-3 rounded-2xl border-black/5 dark:border-white/5">
                    ...
                    <div>
                      ...
                      <div className="text-gray-900 dark:text-white font-bold tracking-tight uppercase text-xs">
                        The Quad Elite
                      </div>
                    </div>
                  </div>
            ...
            {(currentUser?.id === event.organizer._id ||
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-6 relative z-10">
                  <div>
                    ...
                    <p className="text-indigo-400/60 font-medium mt-1 uppercase text-[10px] tracking-widest">
            ...
            >
              ...
              <div className="mb-10 space-y-6">
                ...
                <div className="glass bg-black/5 dark:bg-white/5 rounded-[2.5rem] p-8 border-black/5 dark:border-white/5 flex flex-col items-center">
                  ...
                  <p className="mt-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">
                    Your Digital Access Key
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8 mb-10">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900 dark:text-white tracking-tight">
                      {event.durationMinutes} Minutes Experience
                    </p>
                  </div>
                </div>
              </div>
