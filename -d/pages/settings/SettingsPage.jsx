      ...
      items: [
        {
          ...
          title: "Edit Profile",
          desc: "Your name, bio, avatar, and social links",
          path: "/profile/edit",
        },
        {
          id: "privacy",
      ...
      items: [
        {
          ...
          desc: "Push notifications and email alerts",
        ...
        },
        {
          ...
          desc: "DMs, group chats, and read receipts",
          path: "/settings/chat",
        },
      ],
    },
      ...
      items: [
        {
          ...
          title: "Password",
          desc: "Change your password and 2FA",
        ...
        <div className="md:col-span-2 space-y-8">
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-blue-400/70">
                    Manage users, clubs, and system settings
                  </p>
                </div>
              </div>
          ...
          {sections.map((section, idx) => (
            <div key={idx} className="space-y-4">
              <h2 className="text-xs font-bold text-gray-500 uppercase tracking-widest px-4">
                {section.title}
              </h2>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-[2.5rem] p-8 text-gray-900 dark:text-white shadow-2xl shadow-blue-500/20">
            ...
            <p className="text-blue-100 text-sm mb-6 leading-relaxed">
              Get early access to events, premium club badges, and unlimited
              team matchmaking requests.
            </p>
          ...
          <div className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-[2.5rem] p-8">
            ...
            <nav className="space-y-3">
              <a
                href="#"
                className="block text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white transition-colors"
              >
                Help Center
              </a>
              <a
