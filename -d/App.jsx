    ...
    <SocketProvider>
      <div className="min-h-screen bg-gray-50 dark:bg-[#030303] text-gray-900 dark:text-gray-100 font-sans selection:bg-indigo-500/30 w-full overflow-x-hidden transition-colors duration-300">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-900/10 blur-[130px] rounded-full"
            ...
            {isHome && (
              <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-16 md:pt-28">
                ...
                >
                  ...
                  <motion.h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-8 tracking-tighter leading-[0.9] text-gray-900 dark:text-white">
                    Explore Your <br />
                  ...
                  >
                    The unified ecosystem for events, clubs, and collaborative
                    projects. Stay ahead with real-time campus pulse.
                  </motion.p>
