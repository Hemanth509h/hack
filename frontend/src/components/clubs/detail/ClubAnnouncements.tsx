    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {MOCK_ANNOUNCEMENTS.map((announcement) => (
          <div key={announcement.id} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:border-indigo-500/30 transition-all relative group">
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm">{announcement.author}</h4>
