    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        {filteredMembers.map((member) => (
          <div key={member._id} className="bg-gray-100 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-4 rounded-2xl flex flex-col items-center text-center group hover:bg-gray-900 transition-all">
            ...
            <h4 className="text-sm font-bold text-gray-900 dark:text-white truncate w-full">{member.user.name}</h4>
