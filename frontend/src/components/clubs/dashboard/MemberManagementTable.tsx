...
export const MemberManagementTable: React.FC<MemberManagementTableProps> = ({ members, clubId }) => {
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-950/50 border-bottom border-gray-800">
              ...
              <th className="px-6 py-4 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Joined On</th>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-gray-800 overflow-hidden">
                      {member.user.avatar ? (
                        ...
                        <div className="h-full w-full flex items-center justify-center text-gray-500"><User className="h-5 w-5" /></div>
                      )}
                    </div>
                    <div>
