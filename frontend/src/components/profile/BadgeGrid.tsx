  ...
  if (!badges || badges.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 border border-dashed border-gray-200 dark:border-gray-800 rounded-xl bg-white dark:bg-gray-900/50">
        ...
        <p className="text-gray-600 dark:text-gray-400 font-medium text-center">No badges earned yet.</p>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {badges.map((badge) => (
        ...
        >
          ...
          />
          <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-1 tracking-tight">{badge.name}</h4>
          {badge.earnedAt && (
