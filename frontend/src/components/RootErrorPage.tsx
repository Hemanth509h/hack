  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 text-gray-100 font-sans">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white">Oops! Something went wrong</h2>
        
        <p className="text-gray-400 mb-10 leading-relaxed bg-white/5 p-4 rounded-2xl border border-white/5 font-mono text-sm break-words">
          {errorMessage}
        </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button 
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 text-white font-bold rounded-2xl border border-white/10 transition-all"
          >
            <RotateCcw size={18} />
            Try Again
          </button>
          <button 
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-blue-500/20"
          >
            <Home size={18} />
            Go Home
          </button>
