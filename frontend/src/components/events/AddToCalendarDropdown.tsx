...
const AddToCalendarDropdown = ({ event }: AddToCalendarDropdownProps) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-xl text-gray-200 text-sm font-semibold transition"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-56 bg-gray-900 border border-gray-800 rounded-xl shadow-2xl overflow-hidden z-20"
          >
            <div className="p-1">
              <a 
                href={googleUrl} 
              ...
              <a 
                ...
                className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition"
              >
                <div className="w-6 h-6 rounded bg-gray-700 flex items-center justify-center text-gray-300">
                  <Download size={14} />
                </div>
                Download .ics
              </a>
