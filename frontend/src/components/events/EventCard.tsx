...
export const EventCard: React.FC<EventCardProps> = ({ event, isRecommended }) => {
        ...
        <div className="p-5">
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-gray-800 flex justify-between items-center">
            <div className="flex -space-x-2 overflow-hidden">
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="inline-block h-6 w-6 rounded-full ring-2 ring-gray-900 bg-gray-700">
                  <img
