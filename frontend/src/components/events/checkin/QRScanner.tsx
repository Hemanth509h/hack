       ...
       <div className="relative aspect-square bg-black">
          {!manualMode ? (
             ...
             <div className="absolute inset-0 bg-white dark:bg-gray-900 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">Enter User ID or Student Number to bypass scanner.</p>
            ...
            {scanResult !== 'idle' && (
              <motion.div 
                ...
                className={`absolute inset-0 z-20 flex flex-col items-center justify-center p-6 text-center backdrop-blur-md ${
                  scanResult === 'success' ? 'bg-green-500/80 text-gray-900 dark:text-white' : 'bg-red-500/80 text-gray-900 dark:text-white'
                }`}
              >
