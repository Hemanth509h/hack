  ...
  return (
    <div className="max-w-2xl mx-auto w-full">
      <div className="mb-8">
          ...
          {[1, 2, 3].map((num) => (
            <div 
              ...
              className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-colors duration-300 ${
                step >= num ? 'bg-indigo-600 text-white shadow-[0_0_15px_rgba(79,70,229,0.5)]' : 'bg-gray-800 text-gray-500'
              }`}
            >
              {num}
            </div>
        ...
        <div className="flex justify-between text-xs font-medium text-gray-400 mt-3 -mx-2">
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <input
                    {...register('title')}
                    className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all resize-none"
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
                    />
                    {errors.durationMinutes && <p className="text-red-400 text-sm">{errors.durationMinutes.message}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.locationDetails && <p className="text-red-400 text-sm">{errors.locationDetails.message}</p>}
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">Capacity (Optional)</label>
                  <input
                    type="number"
                    {...register('capacity')}
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-xl text-sm text-indigo-200">
                  By clicking publish, you are confirming this event complies with The Quad's community guidelines. Notification alerts will be sent to corresponding clubs if relevant.
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="flex justify-between items-center mt-10 pt-6 border-t border-gray-800">
            ...
            {step < 3 ? (
              <button
                type="button"
                onClick={nextStep}
                className="flex items-center px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-xl shadow-[0_0_15px_rgba(79,70,229,0.3)] transition-all"
              >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex items-center px-8 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white text-sm font-bold rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.4)] transition-all disabled:opacity-50"
              >
