          ...
          {[1, 2, 3].map((num) => (
            <div 
              ...
              className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-colors duration-300 ${
                step >= num ? 'bg-indigo-600 text-gray-900 dark:text-white shadow-[0_0_15px_rgba(79,70,229,0.5)]' : 'bg-gray-50 dark:bg-gray-800 text-gray-500'
              }`}
            >
              {num}
            </div>
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Assigned Organizer</label>
                  <select
                  ...
                  {errors.organizerId && <p className="text-red-400 text-sm">{errors.organizerId.message}</p>}
                </div>
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Capacity (Optional)</label>
                  <input
                    type="number"
                    {...register('capacity')}
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Cover Image URL (Optional)</label>
                  <input
                    {...register('coverImage')}
                    className="w-full bg-gray-100 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
