...
export const NotificationBadge: React.FC = () => {
  ...
  return (
    <Link to="/notifications" className="relative p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white transition-colors rounded-full hover:bg-gray-800">
