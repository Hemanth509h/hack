...
export const ChatWindow: React.FC<ChatWindowProps> = ({ roomType, roomId, title }) => {
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col justify-end">
        <div className="flex flex-col gap-2">
          {isLoading ? (
             ...
             messages.map(m => <MessageBubble key={m._id || Math.random().toString()} message={m} currentUser={currentUser} />)
          )}
