 ...
 */
export const getTrendingEvents = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const getTrendingClubs = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const getEventRecommendations = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const getClubRecommendations = async (req: AuthRequest, res: Response) => {
  try {
