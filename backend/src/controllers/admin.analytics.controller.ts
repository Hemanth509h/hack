 ...
 */
export const getEngagementTrends = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const getDemographicsAnalytics = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const downloadEngagementReport = async (req: AuthRequest, res: Response) => {
  try {
    const { days } = req.body;
