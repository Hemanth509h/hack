 ...
 * ---------------------------------------------------------------- */
export const computeSkillScore = async (mySkillNames, theirSkillNames) => {
 ...
 * ---------------------------------------------------------------- */
export const computeInterestScore = (myInterests, theirInterests) => {
    return jaccardSimilarity(myInterests.map(i => i.toLowerCase()), theirInterests.map(i => i.toLowerCase()));
};
/** ----------------------------------------------------------------
 ...
 * ---------------------------------------------------------------- */
export const computeCollaborationScore = (myCompletedProjectMemberIds, theirUserId) => {
    let sharedTeams = 0;
...
export const computeMatchScore = (factors) => {
    const raw = factors.skillScore * MATCH_WEIGHTS.skillOverlap +
...
export const setCachedMatches = async (userId, matches) => {
