 ...
 */
export const processAndUploadImage = async (buffer, folder = 'the_quad_media') => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const uploadStream = cloudinary.uploader.upload_stream({ folder, resource_type: 'image', format: 'webp' }, (error, result) => {
            if (error || !result) {
