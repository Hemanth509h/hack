...
export const createEventSchema = Joi.object({
    ...
    category: Joi.string().required().valid('Hackathon', 'Workshop', 'Cultural', 'Sports', 'Career', 'Social', 'Other'),
...
export const updateEventSchema = Joi.object({
    ...
    category: Joi.string().valid('Hackathon', 'Workshop', 'Cultural', 'Sports', 'Career', 'Social', 'Other'),
