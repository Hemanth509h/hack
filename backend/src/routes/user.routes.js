...
router.get('/:id/portfolio', getPortfolio); // Portfolio is always // ---- Profile Mutations (Owner only enforced in controller) ----
...
router.get('/:id/clubs', getUserClubs); // Memberships are // ---- Avatar Upload (multer single file) ----
