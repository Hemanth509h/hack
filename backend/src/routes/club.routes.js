...
import { createClubSchema, updateClubSchema, clubQuerySchema, updateMemberRoleSchema, announcementSchema } from '../validations/club.validation.js';
import { getAllClubs, getFeaturedClubs, createClub, getClubById, updateClub, deactivateClub, joinClub, leaveClub, getClubMembers, updateMemberRole, approveMember, rejectMember, sendClubAnnouncement, getClubAnalytics } from '../controllers/club.controller.js';
const router = Router();
// ---- Discovery (Public) ----
