 ...
 * ---------------------------------------------------------------- */
const templateSource: Record<string, string> = {
  event_update: `
...
const compileTemplate = (type: string, data: Record<string, any>): string => {
...
export interface NotificationPayload {
  ...
  ctaUrl?: string; // Optional call-to-action URL for emails
}
 ...
 */
const sendPushNotification = async (data: { email: string; title: string; message: string; url?: string }) => {
