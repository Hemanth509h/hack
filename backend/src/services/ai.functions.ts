 ...
 */
export const searchEvents = async (args: { query?: string, category?: string, timeframe?: 'today' | 'week' | 'month' }) => {
  try {
 ...
 */
export const findClubs = async (args: { query: string }) => {
  try {
 ...
 */
export const getCampusInfo = async (args: { topic: string }) => {
  try {
